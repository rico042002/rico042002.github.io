  ...
  $(document).ready(function() {
    ...
    quoteData = (list[Object.keys(list)[Math.floor(Math.random()*Object.keys(list).length)]]);
      $(".message").html(quoteData.quote + " ~ " + quoteData.author);
       });
...
//Darell Both version http://codepen.io/darelb/pen/Ndbodw